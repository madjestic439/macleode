...
class Ihm:
    ...
    def creat_ihm(self):
        ...
        self.fr_input_bts.pack(side='left', fill=BOTH, expand=False, ipadx=30)
        ...
        self.fr_output_bts.pack(side='left', fill=BOTH, expand=False, ipadx=50)
        self.fr_output_lst = Frame(self.fr_output, borderwidth=2, relief='groove')
        self.list_crp = Listbox(self.fr_output_lst, width=150)
